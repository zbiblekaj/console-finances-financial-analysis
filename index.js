...
// print a header to the console log
...
console.log(`The greatest increase in profits: ${monthIncrease} ($${greatestIncrease})`);
...
console.log (`The greatest decrease in profits: ${monthDecrease} ($${greatestDecrease})`);
